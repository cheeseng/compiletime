...
val baseDir = new File("target/" + scalaVersion + "/assertBeforeAfter")
if (baseDir.exists)
  deleteDir(baseDir)
...
val testTypes = 
  Array(
    TestType("Before asert(==)", "BeforeEqual2", Array("org.scalatest._"), Array.empty, assertEqual2TestBodyFun, scalatestOldJar),
    TestType("After assert(==)", "AfterEqual2", Array("org.scalatest._"), Array.empty, assertEqual2TestBodyFun, scalatestMacroJar), 
    TestType("Before asert(===)", "BeforeEqual3", Array("org.scalatest._"), Array.empty, assertEqual3TestBodyFun, scalatestOldJar),
    TestType("After assert(===)", "AfterEqual3", Array("org.scalatest._"), Array.empty, assertEqual3TestBodyFun, scalatestMacroJar)
  )
